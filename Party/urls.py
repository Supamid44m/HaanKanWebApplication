...
urlpatterns =[
    ...
    path('<int:id>/delete/',views.delete_party,name="delete"),
    ...
    path('<int:id>/add_member/', views.add_member, name='add_member'),
    path('<int:id>/delete_member/<int:member_id>/', views.delete_member, name='delete_member'),
